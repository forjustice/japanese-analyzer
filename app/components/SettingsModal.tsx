    ...
    <div 
      ...
      >
        <div className="settings-modal-content">
          ...
          <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4">自定义API设置</h3>
          ...
          <div className="mb-4">
            ...
            <label htmlFor="modalApiKeyInput" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              自定义 API 密钥 (可选):
            </label>
            <input 
              type="password" 
              id="modalApiKeyInput" 
              className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-gray-700 dark:text-gray-300" 
          ...
          <div className="mb-4">
            <label htmlFor="modalApiUrlInput" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              自定义 API URL (可选):
            </label>
            <input 
              type="text" 
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              ...
              <code className="px-1 py-0.5 bg-gray-100 dark:bg-gray-600 dark:text-gray-300 rounded">v1/chat/completions</code>
            </p>
          </div>
          
          <div className="mb-4">
            <div className="flex items-center justify-between">
              <label htmlFor="useStreamToggle" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                启用流式输出:
              </label>
